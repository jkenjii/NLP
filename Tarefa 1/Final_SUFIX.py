...
def SufixoMaior1(size, histWords):
	size
	pref = []
...
df_pref = pd.DataFrame(SufixoMaior1(5,histWords), columns=['Sufixo', 'Frequencia'])
print(df_pref)
soma_dos_iguais = df_pref.groupby('Sufixo').sum()[['Frequencia']]
